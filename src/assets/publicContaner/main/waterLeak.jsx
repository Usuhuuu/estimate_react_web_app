...
const Waterleak = () => {
  ...
  [
    {id:8.2, text:"누수 위치 장소는 어디인가요?", options:['지하','욕실','발코니','기타']},
    {id:8.3, text:"어떻게 누수가 타고 있는지 설명해 주세요", options:['해당없음']},
  ...
  const handleSubmit = async ({setSubmitting}) => {
    try{
      ...
      if(!authToken){
        ...
        try {
          console.log('haridss',answeredQuestions )
