...
const Interior = () => {
  ...
  [{id:1, text: '어떤 인테리어 원하십니까?', options: ["주거 공간 인테리어", "상업공간 인테리어"] },],
[
    
  {id:10.1, text:'어떤 건물인지 선택해 주세요', options:["아파트","단독주택","빌라","오피스텔","기타"]},
  {id:2.2, text:"시공 일자", options:['1개월 이내','2개월 이내','3개월 이내','해당 없음']},
  {id:2.3, text:"형제 계약 상태", options:['형재 입주 중', '계약 완료 및 공실 상태', '가계약 완료/계약 예정', '계약 전']},
  {id:2.4, text:"시공 면적", options:['10평 이하','10평 - 20평', '30평 - 40평', '40평 - 50평', '해당 없음']},
  {id:2.5, text:"바닥 시공 원하십니까?", options:['해당 없음','강마루','강화마루','장판','대리석', '기타']},
  {id:2.6, text:"주방시공 원하십니까?", options:['해당 없음','전체 교체(사제)','전체 교체(브랜드)', '필름만 시공','타일만 시공','기타']},
  {id:2.7, text:"욕실시공 원하십니까?", options:['해당 없음','전체 교체','도기만 교체', '타일만 교체','기타']},
  {id:2.8, text:"샷지기공 원하십니까?", options:['해당 없음','전체 교체','부분 교체', '필름만 시공','기타']},
  {id:2.9, text:"베란다 시공 원하십니까?", options:['해당 없음','거실 확장','방 확장', '베란다 단올림','기타']},
  {id:3.1, text:"방문 보수/교체 원하십니까?", options:['해당 없음','전체 교체','부분 교체', '필름만 시공','기타']},
  {id:3.2, text:"현관문 시공 원하십니까?", options:['해당 없음','신발장','타일', '가벽',"중문",'기타']},
  {id:3.3, text:"조명 시공 원하십니까?", options:['해당 없음','전체 교체','등/스위치만 교체','전기만 시공', '기타']},
  {id:10.4, text:"공사는 언제부터 가능하신가요?", options:['협의 가능해요','가능한 빨리 진행하고 싶습니다','일주일 이내로 진행하고 싶습니다','원하는 날짜가 있습니다','기타']},
  {id:10.5, text:"현장 방문할 날짜", options:['협의 가능해요','가능한 빨리 진행하고 싶습니다','일주일 이내로 진행하고 싶습니다','원하는 날짜가 있습니다','기타']},
  {id:3.5, text:"인테리어 예상 금액", options:['상담 후 결정','1000만 원 미만','1000만 - 2000만 원','2000만 - 3000만 원', '3000만 - 4000만 원','4000만 - 5000만 원','5000만 원 이상']},
...
[
  {id:10.6, text:'어떤 건물인지 선택해 주세요', options:['상가','사무실','식당','학원','병원','숙박시설','카페','기타']},
    
  {id:4.2, text:"시공 일자", options:['1개월 이내','2개월 이내','3개월 이내','해당 없음']},
  {id:4.4, text:"형제 계약 상태", options:['형재 입주 중', '계약 완료 및 공실 상태', '가계약 완료/계약 예정', '계약 전']},
  {id:10.4, text:"공사 현장 방문 실사 가능 날자?", options:['협의 가능해요','가능한 빨리 진행하고 싶습니다','일주일 이내로 진행하고 싶습니다','원하는 날짜가 있습니다','기타']},
  {id:4.6,  text:"인테리어 예상 금액", options:['상담 후 결정','1000만 원 미만','1000만 - 2000만 원','2000만 - 3000만 원', '3000만 - 4000만 원','4000만 - 5000만 원','5000만 원 이상']},
  {id:10.3, text:"시공 면적", options:['10평 이하','10평 - 20평', '30평 - 40평', '40평 - 50평', '해당 없음']},
  {id: 10.2, text: "주소를 선택해 주세요",options: [
    { label: "서울", districts: ["강남구", "강동구", "강북구", "강서구", "관악구", "광진구", "구로구", "금천구", "노원구", "도봉구", "동대문구", "동작구", "마포구", "서대문구", "서초구", "성동구", "성북구", "송파구", "양천구", "영등포구", "용산구", "은평구", "종로구", "중구", "중랑구"] },
    { label: "인천", districts: ["강화군", "계양구", "남동구", "동구", "미추홀구", "부평구", "서구", "연수구", "옹진군"] },
    { label: "경기", districts: ["가평군", "고양시", "과천시", "광명시", "광주시", "구리시", "군포시", "김포시", "남양주시", "동두천시", "부천시", "성남시", "수원시", "시흥시", "안산시", "안성시", "안양시", "양주시", "양평군", "여주시", "연천군", "오산시", "용인시", "의왕시", "의정부시", "이천시", "파주시", "평택시", "포천시", "하남시", "화성시"] },
