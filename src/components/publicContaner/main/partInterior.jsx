          ...
          <div className="imageContainers">
            <div className="imageChange">
              <div className="imagesss">
                <Link to="/interior/kitchen" className="image-link">
                  <img src="/Photo/kitchen.jpg" alt="" />
                  <p>주방</p>
                </Link>
              </div>
              <div className="imagesss">
                <Link to="/interior/floorAndWall" className="image-link">
                  <img src="/Photo/wall.jpg" alt="" />
                  <p>도배</p>
                </Link>
              </div>
            </div>
