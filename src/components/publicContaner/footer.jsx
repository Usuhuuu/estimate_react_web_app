...
import { faInstagram, faFacebook, faBlogger } from '@fortawesome/free-brands-svg-icons';
const Footer =() => {
return(
<>
  ...
  <div className="footer__addr">
    ...
    <address>
      ...
      <div className="icon_container">
        ...
        <a href="https://www.exampleblog.com"  target="_blank" rel="noopener noreferrer">
  ...
  <div></div>
    <ul className="footer__nav">
        ...
        <div className="app-buttons">
          ...
          <img className="Zurags"src="/Photo/Download_on_the_App_Store_Badge_KR_RGB_blk_100317.svg" alt="" />
          </a>
          <a href="#" target="_blank" rel="noopener noreferrer">
          <img className="Zurags" src="/Photo/google-play-badge.svg" alt="" />
          </a>
        </div>
    </ul>
</footer>
